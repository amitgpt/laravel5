...
<body>
  ...
  <div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
      <div class="container">
        <br><br>
        <h1 class="header center teal-text text-lighten-2">Man must explore, and this is exploration at its greatest</h1>
        <hr class="small">
        <div class="row center">
          <h4 class="header col s12 light">Problems look mighty small from 150 miles up</h4>
            <p class="post-meta">Posted by <a href="#">Smartsbee App</a> on April 14, 2015</p>
        </div>
        <br><br>

      </div>
    </div>
    <div class="parallax"><img src="frontend/background1.jpg" alt="Unsplashed background img 2"></div>
  </div>
          ...
          <div class="icon-block">
			  ...
			  <p>There can be no thought of finishing for ‘aiming for the stars.’ Both figuratively and literally, it is a task to occupy the generations. And no matter how much progress one makes, there is always the thrill of just beginning.</p>
				...
				<a href="#">
                        ...
                        <img src="frontend/post-sample-image.jpg" alt="Unsplashed background img 2">
                    </a>
				
					<span><br/>To go places and do things that have never been done before – that’s what living is all about.</span>
